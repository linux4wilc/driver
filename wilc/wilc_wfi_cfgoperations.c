...
#endif
		PRINT_ER(vif->ndev,
			 "Received WILC_MAC_STATUS_DISCONNECTED from firmware with reason %d on dev [%p]\n",
...
#endif
{
	...
	case NL80211_IFTYPE_STATION:
		...
		wilc_set_wfi_drv_handler(vif, wilc_get_vif_idx(vif),
					 WILC_STATION_MODE, vif->ifc_id, false);
